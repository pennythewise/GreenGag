"""Pydantic models and mappers for LLM extraction output."""
...
from models.schemas import EsgPillar, ExtractedClaim, HighlightBox
...
class RetrievedChunk(BaseModel):
    ...
    pillar_scores: dict[EsgPillar, float] = Field(default_factory=dict)
